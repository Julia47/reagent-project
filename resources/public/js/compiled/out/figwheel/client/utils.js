...
return (new CustomEvent(event_name,(function (){var obj33837 = ({"detail":data});
return obj33837;
})()));
} else {
...
var f = (function (){var pred__33844 = cljs.core._EQ_;
var expr__33845 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33844.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33845))){
return (function (p1__33838_SHARP_){
return console.warn(p1__33838_SHARP_);
});
} else {
if(cljs.core.truth_(pred__33844.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33845))){
return (function (p1__33839_SHARP_){
return console.debug(p1__33839_SHARP_);
});
} else {
if(cljs.core.truth_(pred__33844.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33845))){
return (function (p1__33840_SHARP_){
return console.error(p1__33840_SHARP_);
});
} else {
return (function (p1__33841_SHARP_){
return console.log(p1__33841_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33848){
...
var eval_fn = cljs.core.get.call(null,map__33849__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__33851_SHARP_){
return new_def.callback(p1__33851_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__33852){
var vec__33853 = p__33852;
var ky = cljs.core.nth.call(null,vec__33853,(0),null);
var v = cljs.core.nth.call(null,vec__33853,(1),null);
...
}catch (e33858){if((e33858 instanceof Error)){
var e = e33858;
return not_found;
} else {
throw e33858;
...
//# sourceMappingURL=utils.js.map?rel=1637270084530
