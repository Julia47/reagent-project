...
return (new CustomEvent(event_name,(function (){var obj44150 = ({"detail":data});
return obj44150;
})()));
} else {
...
var f = (function (){var pred__44157 = cljs.core._EQ_;
var expr__44158 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44157.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44158))){
return (function (p1__44151_SHARP_){
return console.warn(p1__44151_SHARP_);
});
} else {
if(cljs.core.truth_(pred__44157.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44158))){
return (function (p1__44152_SHARP_){
return console.debug(p1__44152_SHARP_);
});
} else {
if(cljs.core.truth_(pred__44157.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44158))){
return (function (p1__44153_SHARP_){
return console.error(p1__44153_SHARP_);
});
} else {
return (function (p1__44154_SHARP_){
return console.log(p1__44154_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44161){
var map__44162 = p__44161;
var map__44162__$1 = (((((!((map__44162 == null))))?(((((map__44162.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44162.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44162):map__44162);
var opts = map__44162__$1;
var eval_fn = cljs.core.get.call(null,map__44162__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__44164_SHARP_){
return new_def.callback(p1__44164_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__44165){
var vec__44166 = p__44165;
var ky = cljs.core.nth.call(null,vec__44166,(0),null);
var v = cljs.core.nth.call(null,vec__44166,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1637933617558
