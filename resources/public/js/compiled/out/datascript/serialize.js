...
if(cljs.core.empty_QMARK_.call(null,new cljs.core.Keyword(null,"aevt","aevt",-585148059).cljs$core$IFn$_invoke$arity$1(db))){
return cljs.core.PersistentVector.EMPTY;
} else {
var attrs = cljs.core.transient$.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,new cljs.core.Keyword(null,"aevt","aevt",-585148059).cljs$core$IFn$_invoke$arity$1(db)))], null));
while(true){
...
var next_attr = new cljs.core.Keyword(null,"a","a",-2123407586).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,me.tonsky.persistent_sorted_set.slice.call(null,new cljs.core.Keyword(null,"aevt","aevt",-585148059).cljs$core$IFn$_invoke$arity$1(db),left,right,datascript.serialize.attr_comparator)));
if((!((next_attr == null)))){
var G__36604 = cljs.core.conj_BANG_.call(null,attrs,next_attr);
attrs = G__36604;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__36605){
...
var freeze_fn = cljs.core.get.call(null,map__36606__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var attrs = datascript.serialize.all_attrs.call(null,db);
...
var schema = freeze_fn.call(null,new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db));
...
return datascript.serialize.serializable_impl.call(null,db,cljs.core.PersistentArrayMap.EMPTY);
}));

(datascript.serialize.serializable.cljs$core$IFn$_invoke$arity$2 = (function (db,opts){
return datascript.serialize.serializable_impl.call(null,db,opts);
}));
...
(datascript.serialize.from_serializable.cljs$core$IFn$_invoke$arity$2 = (function (from,p__36615){
...
var thaw_fn = cljs.core.get.call(null,map__36616__$1,new cljs.core.Keyword(null,"thaw-fn","thaw-fn",-240544261),clojure.edn.read_string);
...
var pred__36618 = cljs.core._EQ__EQ_;
var expr__36619 = marker;
if(cljs.core.truth_(pred__36618.call(null,(0),expr__36619))){
return cljs.core.nth.call(null,keywords,datascript.serialize.array_get.call(null,v,(1)));
} else {
if(cljs.core.truth_(pred__36618.call(null,(1),expr__36619))){
...
var aevt = (function (){var G__36621 = datascript.serialize.dict_get.call(null,from,"aevt");
if((G__36621 == null)){
return null;
} else {
return datascript.serialize.amap.call(null,(function (p1__36611_SHARP_){
return (eavt[p1__36611_SHARP_]);
}),G__36621);
}
})();
var avet = (function (){var G__36622 = datascript.serialize.dict_get.call(null,from,"avet");
if((G__36622 == null)){
return null;
} else {
return datascript.serialize.amap.call(null,(function (p1__36612_SHARP_){
return (eavt[p1__36612_SHARP_]);
}),G__36622);
}
})();
...
//# sourceMappingURL=serialize.js.map?rel=1637933613603
