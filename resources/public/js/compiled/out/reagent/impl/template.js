...
var G__21739 = o;
goog.object.set(G__21739,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__21740__delegate = function (args){
...
while (G__21741__i < G__21741__a.length) {G__21741__a[G__21741__i] = arguments[G__21741__i + 0]; ++G__21741__i;}
  args = new cljs.core.IndexedSeq(G__21741__a,0,null);
} 
...
var args = cljs.core.seq(arglist__21742);
...
var G__21743 = o;
goog.object.set(G__21743,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__21744__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__21745__i < G__21745__a.length) {G__21745__a[G__21745__i] = arguments[G__21745__i + 0]; ++G__21745__i;}
  args = new cljs.core.IndexedSeq(G__21745__a,0,null);
} 
return G__21744__delegate.call(this,args);};
...
return G__21744__delegate(args);
});
...
var G__21747 = props;
var G__21747__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21747,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21747);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21747__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__21748 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21748,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__21748;
}
})(),id_class);
...
var G__21749 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21749) {
case (0):
...
var vec__21751 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21751,(0),null);
var id = cljs.core.nth.call(null,vec__21751,(1),null);
var className = cljs.core.nth.call(null,vec__21751,(2),null);
...
var temp__5724__auto___21754 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___21754 == null)){
} else {
var key_21755 = temp__5724__auto___21754;
(jsprops.key = key_21755);
}
...
var temp__5724__auto___21756 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___21756 == null)){
} else {
var key_21757 = temp__5724__auto___21756;
(jsprops.key = key_21757);
}
...
var temp__5724__auto___21758 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___21758 == null)){
} else {
var key_21759 = temp__5724__auto___21758;
(jsprops.key = key_21759);
}
...
var temp__5724__auto___21760 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___21760 == null)){
} else {
var key_21761 = temp__5724__auto___21760;
(jsprops.key = key_21761);
}
...
var temp__5724__auto___21762 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___21762 == null)){
} else {
var key_21763 = temp__5724__auto___21762;
(jsprops.key = key_21763);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__21764_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__21764_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21765 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__21765,(0),null);
var derefed = cljs.core.nth.call(null,vec__21765,(1),null);
...
break;
default:
var G__21770 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__21771 = compiler;
v = G__21770;
compiler = G__21771;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21775 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21775 = (function (opts,id,fn_to_element,parse_fn,meta21776){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21775.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21777,meta21776__$1){
var self__ = this;
var _21777__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21775(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21776__$1));
}));

(reagent.impl.template.t_reagent$impl$template21775.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21777){
var self__ = this;
var _21777__$1 = this;
return self__.meta21776;
}));

(reagent.impl.template.t_reagent$impl$template21775.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21775.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21775.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template21775.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21775.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21775.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21776","meta21776",406646773,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21775.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21775.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21775");

(reagent.impl.template.t_reagent$impl$template21775.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template21775");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21775.
 */
reagent.impl.template.__GT_t_reagent$impl$template21775 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21775(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21776){
return (new reagent.impl.template.t_reagent$impl$template21775(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21776));
});

}

return (new reagent.impl.template.t_reagent$impl$template21775(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1637141748549
