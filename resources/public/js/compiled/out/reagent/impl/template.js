...
var G__37235 = o;
goog.object.set(G__37235,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__37239 = o;
goog.object.set(G__37239,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__37243 = props;
var G__37243__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__37243,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37243);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__37243__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__37244 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__37244,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__37244;
}
})(),id_class);
...
var G__37245 = (cljs.core.count.call(null,argv) - first_child);
switch (G__37245) {
case (0):
...
var vec__37247 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__37247,(0),null);
var id = cljs.core.nth.call(null,vec__37247,(1),null);
var className = cljs.core.nth.call(null,vec__37247,(2),null);
...
var temp__5724__auto___37250 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___37250 == null)){
} else {
var key_37251 = temp__5724__auto___37250;
(jsprops.key = key_37251);
}
...
var temp__5724__auto___37252 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___37252 == null)){
} else {
var key_37253 = temp__5724__auto___37252;
(jsprops.key = key_37253);
}
...
var temp__5724__auto___37254 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___37254 == null)){
} else {
var key_37255 = temp__5724__auto___37254;
(jsprops.key = key_37255);
}
...
var temp__5724__auto___37256 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___37256 == null)){
} else {
var key_37257 = temp__5724__auto___37256;
(jsprops.key = key_37257);
}
...
var temp__5724__auto___37258 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___37258 == null)){
} else {
var key_37259 = temp__5724__auto___37258;
(jsprops.key = key_37259);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__37260_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__37260_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37261 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__37261,(0),null);
var derefed = cljs.core.nth.call(null,vec__37261,(1),null);
...
break;
default:
var G__37266 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__37267 = compiler;
v = G__37266;
compiler = G__37267;
continue;
...
var G__37268 = tag;
var G__37268__$1 = (((G__37268 instanceof cljs.core.Keyword))?G__37268.fqn:null);
switch (G__37268__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37271 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37271 = (function (opts,id,fn_to_element,parse_fn,meta37272){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37271.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37273,meta37272__$1){
var self__ = this;
var _37273__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37271(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37272__$1));
}));

(reagent.impl.template.t_reagent$impl$template37271.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37273){
var self__ = this;
var _37273__$1 = this;
return self__.meta37272;
}));

(reagent.impl.template.t_reagent$impl$template37271.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37271.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37271.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template37271.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37271.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37271.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37272","meta37272",389544280,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37271.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37271.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37271");

(reagent.impl.template.t_reagent$impl$template37271.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template37271");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37271.
 */
reagent.impl.template.__GT_t_reagent$impl$template37271 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37271(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37272){
return (new reagent.impl.template.t_reagent$impl$template37271(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37272));
});

}

return (new reagent.impl.template.t_reagent$impl$template37271(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1637933614215
