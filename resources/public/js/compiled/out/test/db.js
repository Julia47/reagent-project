 ...
 */
test.db.schema = cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("transaction","money-source","transaction/money-source",-878971968),new cljs.core.Keyword("money-source","name","money-source/name",-388621823),new cljs.core.Keyword("transaction","money","transaction/money",-1907457661),new cljs.core.Keyword("transaction","date","transaction/date",694214084),new cljs.core.Keyword("money-source","type","money-source/type",-1033885852),new cljs.core.Keyword("transaction","flow","transaction/flow",-1568838874),new cljs.core.Keyword("tag","expense-tag","tag/expense-tag",-243837593),new cljs.core.Keyword("tag","income-tag","tag/income-tag",1411796465),new cljs.core.Keyword("money-source","account-number","money-source/account-number",1575588631),new cljs.core.Keyword("money-source","balance","money-source/balance",-2075485799),new cljs.core.Keyword("transaction","tag","transaction/tag",863365855)],[new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("db","valueType","db/valueType",1827971944),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079),new cljs.core.Keyword("db","isComponent","db/isComponent",423352398),true,new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659),new cljs.core.Keyword("db.cardinality","one","db.cardinality/one",1428352190)], null),cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","doc","db/doc",1913350069),"boolean, if income - true, expense -false"], null),cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("db","valueType","db/valueType",1827971944),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079),new cljs.core.Keyword("db","isComponent","db/isComponent",423352398),true,new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659),new cljs.core.Keyword("db.cardinality","one","db.cardinality/one",1428352190)], null)]);
...
return (p1__46813_SHARP_ + new cljs.core.Keyword("transaction","money","transaction/money",-1907457661).cljs$core$IFn$_invoke$arity$1(data));
} else {
return (p1__46813_SHARP_ - new cljs.core.Keyword("transaction","money","transaction/money",-1907457661).cljs$core$IFn$_invoke$arity$1(data));
}
...
var rand_nums = (function (p1__46814_SHARP_,p2__46815_SHARP_){
return cljs.core.rand_nth.call(null,cljs.core.range.call(null,p1__46814_SHARP_,p2__46815_SHARP_));
});
var money_source = rand_nums.call(null,(18),(22));
var income_tag = rand_nums.call(null,(1),(5));
var expense_tag = rand_nums.call(null,(5),(18));
...
var tag = (cljs.core.truth_(flow)?income_tag:expense_tag);
...
return cljs.core.reduce.call(null,(function (acc,m){
return cljs.core.update.call(null,(cljs.core.truth_(new cljs.core.Keyword("transaction","flow","transaction/flow",-1568838874).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.call(null,acc,new cljs.core.Keyword(null,"income","income",654385502),(function (p1__46816_SHARP_){
return (p1__46816_SHARP_ + new cljs.core.Keyword("transaction","money","transaction/money",-1907457661).cljs$core$IFn$_invoke$arity$1(m));
})):cljs.core.update.call(null,acc,new cljs.core.Keyword(null,"expense","expense",1909150212),(function (p1__46817_SHARP_){
return (p1__46817_SHARP_ + new cljs.core.Keyword("transaction","money","transaction/money",-1907457661).cljs$core$IFn$_invoke$arity$1(m));
}))),new cljs.core.Keyword(null,"flow","flow",590489032),(function (p1__46818_SHARP_){
return (p1__46818_SHARP_ + new cljs.core.Keyword("transaction","money","transaction/money",-1907457661).cljs$core$IFn$_invoke$arity$1(m));
}));
}),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"flow","flow",590489032),(0),new cljs.core.Keyword(null,"expense","expense",1909150212),(0),new cljs.core.Keyword(null,"income","income",654385502),(0)], null),test.db.get_transactions.call(null));
});
test.db.get_data_chart = (function test$db$get_data_chart(){
var str_to_date = (function (str_data){
var vec__46819 = cljs.core.mapv.call(null,(function (s){
...
var year = cljs.core.nth.call(null,vec__46819,(0),null);
var month = cljs.core.nth.call(null,vec__46819,(1),null);
var day = cljs.core.nth.call(null,vec__46819,(2),null);
return Date.UTC(year,month,day);
});
return cljs.core.reduce.call(null,(function (acc,p__46822){
var vec__46823 = p__46822;
var m = cljs.core.nth.call(null,vec__46823,(0),null);
var v = cljs.core.nth.call(null,vec__46823,(1),null);
...
return cljs.core.conj.call(null,acc,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),(cljs.core.truth_(flow)?new cljs.core.Keyword("tag","income-tag","tag/income-tag",1411796465).cljs$core$IFn$_invoke$arity$1(m):new cljs.core.Keyword("tag","expense-tag","tag/expense-tag",-243837593).cljs$core$IFn$_invoke$arity$1(m)),new cljs.core.Keyword(null,"color","color",1011675173),(cljs.core.truth_(flow)?"rgb(9, 180, 165, .5)":"rgb(255, 160, 122, .7)"),new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.vec.call(null,cljs.core.map.call(null,(function (t){
...
//# sourceMappingURL=db.js.map?rel=1637933676922
