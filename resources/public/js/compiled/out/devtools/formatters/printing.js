...
var len__4736__auto___32934 = arguments.length;
var i__4737__auto___32935 = (0);
while(true){
if((i__4737__auto___32935 < len__4736__auto___32934)){
args__4742__auto__.push((arguments[i__4737__auto___32935]));

var G__32936 = (i__4737__auto___32935 + (1));
i__4737__auto___32935 = G__32936;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32931){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32932,G__32933,seq32931__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32937_SHARP_){
return (!((cljs.core.meta.call(null,p1__32937_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__32938__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32942){var _e__32167__auto__ = e32942;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e32944){var _e__32167__auto__ = e32944;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32946 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32947 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32947);

try{var map__32948 = opts;
...
var markup_db = cljs.core.get.call(null,map__32948__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32946);
}});
...
var temp__5718__auto___32953 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___32953)){
var managed_print_level_32954 = temp__5718__auto___32953;
var _STAR_print_level_STAR__orig_val__32951_32955 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32952_32956 = managed_print_level_32954;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32952_32956);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__32950_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__32950_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32951_32955);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1637270083603
